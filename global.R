...
#  })
  ...
  dimensiondetails$colors[dimensiondetails$order==1] <- "#f99f9f" #"#f23030"
  dimensiondetails$colors[(dimensiondetails$order==2)&(dimensiondetails$maxn==3)] <- "#98e698" #"#199f3d"
  dimensiondetails$colors[(dimensiondetails$order==2)&(dimensiondetails$maxn==5)] <- "#b7da71" #"#ee7b07"
  dimensiondetails$colors[(dimensiondetails$order==3)&(dimensiondetails$maxn==3)] <- "#8eb0f1"  #"#306ef2"
  dimensiondetails$colors[(dimensiondetails$order==3)&(dimensiondetails$maxn==5)] <- "#79d2a1"  #"#199f3d"
  dimensiondetails$colors[(dimensiondetails$order==4)&(dimensiondetails$maxn==5)] <- "#9dd7fb"  #"#30b2f2"
  dimensiondetails$colors[(dimensiondetails$order==5)&(dimensiondetails$maxn==5)] <- "#b299e6" #"#4030f2"
