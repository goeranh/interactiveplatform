...
To run HEAT Plus on your Windows machine, download the compressed "HEAT Plus 
for Windows" (zip) file, unzip the file and save the content to your computer's 
hard drive. Select the “HEAT Plus for Windows” folder and double-click the 
“Start_HEATPlus.bat” file. The toolkit will automatically open in a Firefox 
Portable browser window.
